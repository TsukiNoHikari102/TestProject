...
#include "Core/GAS/TargetActors/TargetActor_LineTrace.h"
...
void ATargetActor_LineTrace::Configure(const FGameplayAbilityTargetingLocationInfo& InStartLocation,
                                       ...
                                       bool bInUseAimingSpreadMod, float InMaxRange, float InBaseSpread,
                                       float InAimingSpreadMod,
                                       float InTargetingSpreadIncrement, float InTargetingSpreadMax,
...
void ATargetActor_LineTrace::DoTrace(TArray<FHitResult>& HitResults, const UWorld* World,
...
void ATargetActor_LineTrace::ShowDebugTrace(TArray<FHitResult>& HitResults, EDrawDebugTrace::Type DrawDebugType,
                                            float Duration)
{
...
#if ENABLE_DRAW_DEBUG
void ATargetActor_LineTrace::DrawDebugLineTraceMulti(const UWorld* World, const FVector& Start, const FVector& End,
