...
#include "Core/GAS/TargetActors/TargetActor_SphereTrace.h"
#include "WorldCollision.h"
#include "DrawDebugHelpers.h"
#include "GameFramework/PlayerController.h"

ATargetActor_SphereTrace::ATargetActor_SphereTrace()
{
	TraceSphereRadius = 100.0f;
}

void ATargetActor_SphereTrace::Configure(const FGameplayAbilityTargetingLocationInfo& InStartLocation,
                                         ...
                                         bool bInUsePersistentHitResults, bool bInDebug, bool bInTraceAffectsAimPitch,
                                         bool bInTraceFromPlayerViewPoint,
                                         bool bInUseAimingSpreadMod, float InMaxRange, float InTraceSphereRadius,
                                         float InBaseSpread,
                                         float InAimingSpreadMod, float InTargetingSpreadIncrement,
...
void ATargetActor_SphereTrace::SphereTraceWithFilter(TArray<FHitResult>& OutHitResults, const UWorld* World,
...
void ATargetActor_SphereTrace::DoTrace(TArray<FHitResult>& HitResults, const UWorld* World,
...
void ATargetActor_SphereTrace::ShowDebugTrace(TArray<FHitResult>& HitResults, EDrawDebugTrace::Type DrawDebugType,
                                              float Duration)
{
...
#if ENABLE_DRAW_DEBUG
void ATargetActor_SphereTrace::DrawDebugSweptSphere(const UWorld* InWorld, FVector const& Start, FVector const& End,
...
void ATargetActor_SphereTrace::DrawDebugSphereTraceMulti(const UWorld* World, const FVector& Start, const FVector& End,
